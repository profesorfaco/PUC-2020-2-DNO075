...
|:---------|:-----:|:-----:|:-----:|:-----:|:-----:|
| **Título y autoría en formato curso**. Habiéndose acomodado a un modelo acordado por el curso, que lo vincula con otros trabajos, ofrece un título distinto, claro y veraz: Se entiende lo que sigue después del scroll, y el scroll revela la narrativa esperada | | | | | |
